...
@app.post("/create-account-link")
def create_account_link(data: AccountLinkRequest):
    try:
        account_link = stripe.AccountLink.create(
            account=data.account_id,
            refresh_url=f"{FRONTEND_URL}/reauth",
...
@app.post("/create-login-link")
def create_login_link(data: LoginLinkRequest):
    try:
        login_link = stripe.Account.create_login_link(data.account_id)
